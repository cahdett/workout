  ...
  return (
    <div className="flex min-h-full flex-col items-center justify-center gap-8 px-6 text-center">
      <div>
        ...
        <p className="mt-2 text-zinc-400">Log lifts, follow routines, and track your progress.</p>
      </div>
      <button
        onClick={signInWithGoogle}
        className="flex items-center gap-3 rounded-full bg-white px-6 py-3 font-medium text-zinc-900 shadow-lg active:scale-95 transition-transform"
      >
